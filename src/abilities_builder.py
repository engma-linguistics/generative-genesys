...
#     'isConflictTalent': False,
#     'xpCost': 0},
#    {'id': '53520ffc-29b1-47dc-8174-346fe6ffdc18',
#     'name': 'Silhouette 4',
#     'purchased': True,
#     'activationType': '[nds character activation type] passive',
...
#     'isConflictTalent': False,
#     'xpCost': 0},
#    {'id': 'f3ddd557-bf6d-4b4c-9d31-33f08c9f2100',
#     'name': 'Improved Sweep',
#     'purchased': True,
#     'activationType': '[nds character activation type] passive',
#     'description': 'The creature can spend :n^: on a successful Brawl check to hit an additional target that is Engaged with the first target',
#     'modifiers': [],
#     'ranked': False,
#     'ranks': 0,
#     'isForceTalent': False,
#     'isConflictTalent': False,
#     'xpCost': 0},
#    {'id': 'a428bc0f-5c9e-4e37-989a-aff719637ab3',
#     'name': 'Terrifying 4',
#     'purchased': True,
#     'activationType': '[nds character activation type] passive',
#     'description': "Upon first sight, an individual must make a fear check with a difficulty equal to the adversary's ranks in Terrifying.",
#     'modifiers': [],
#     'ranked': False,
#     'ranks': 0,
#     'isForceTalent': False,
#     'isConflictTalent': False,
#     'xpCost': 0},
#    {'id': '9f1d6b3b-87ec-47e4-a8cd-5d3c76ad3b2f',
#     'name': 'Adversary 2',
#     'purchased': True,
#     'activationType': '[nds character activation type] passive',
#     'description': 'Upgrade the difficulty of any combat check targeting this character 2 times.',
#     'modifiers': [],
#     'ranked': False,
#     'ranks': 0,
#     'isForceTalent': False,
#     'isConflictTalent': False,
#     'xpCost': 0},
#    {'id': '92d76bb8-3280-4438-a4ef-865a4e349057',
#     'name': 'Swift',
#     'purchased': True,
#     'activationType': '[nds character activation type] passive',
...
ABILITY_TEMPLATE_STRING = """
{
    ...
    "ranked": false, # ranked abilities are ones that can be taken multiple times, like talents; this is a boolean. For ranked abilities, the tier represents the number of times it was taken
